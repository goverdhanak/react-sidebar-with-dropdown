  ...
  return (
    ...
    >
      <div style={{ paddingTop: "13px", padding: "13px" }}>
        ...
        <br />
        <Tippy
          content={<span className="hover_name">Within City</span>}
          placement="right"
        >
          <Link to="/location/within/city/penetration">
            <IoLocation
              size={25}
              className={
                location.pathname === "/location/within/city/penetration"
                  ? "active"
                  : "side_icons_style"
              }
            />
        ...
        <div className="my-4">
          <Tippy
            content={<span className="hover_name">New City</span>}
            placement="right"
          >
            <Link to="/location/new/city/expansion">
              <IoCompass
                size={25}
                className={
                  location.pathname === "/location/new/city/expansion"
                    ? "active"
                    : "side_icons_style"
                }
              />
        ...
        <Tippy
          content={<span className="hover_name">Dark Catchment</span>}
          placement="right"
        >
          <Link to="/location/dark/catchment/expansion">
            <IoColorFilter
              size={25}
              className={
                location.pathname === "/location/dark/catchment/expansion"
                  ? "active"
                  : "side_icons_style"
              }
            />
